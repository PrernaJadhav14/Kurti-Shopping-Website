    ...
    <body id="page-top">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item mx-0 mx-lg-1 bg-danger"><a
                                class="nav-link py-3 px-0 px-lg-3 rounded" href="login.jsp"><%=session.getAttribute("name")%></a>
                        </li>
                        <%} else { %>
                        <li class="nav-item mx-0 mx-lg-1 bg-danger"><a
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
                     alt="..." />
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">Welcome To MyMyntra</h1>
                <!-- Icon Divider-->
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">Clothes
                    Shoes - Brand - Lifestyle</p>
            </div>
        </header>
        <!-- Portfolio Section-->
        <section class="page-section portfolio" id="portfolio">
            <div class="container">
                ...
                <form name="f1" action="cart.jsp" method="Get">
                    <table>  
                        <div class ="row">
                            <div class="card w-20" style="width:18rem; margin-right:50px; margin-bottom: 20px">
                                <img class="card-img-top" src="images/kurti.png" alt="" >
                                <div class="card-body">
                                    <h5 class="card-title">Card title</h5>
                                    <h6 class="price">Price: Rupees 500/-</h6>
                                    ...
                                    <div class="mt-4 d-flex justify-content-between">
                                        ...
                                        <input type="submit" class="btn btn-primary" name="add1" value="Add to cart">
                                        <input type="submit" class="btn btn-primary" name="buy1" value="Buy Now">
                            ...
                            <div class="card w-20" style="width:18rem;margin-right:50px;margin-bottom: 20px">
                                <img class="card-img-top" src="kurti2.webp" alt="" >
                                <div class="card-body">
                                    <h5 class="card-title">Card title</h5>
                                    <h6 class="price">Price: Rupees 1000/-</h6>
                                    <h6 class="category">Category: some category</h6>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" value="" name="p2" >
                                        <!--<label class="form-check-label" for="defaultCheck1">-->
                                            Small
                                        <!--</label>-->
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" value="" name="p2" id="defaultCheck1">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <div class="mt-4 d-flex justify-content-between">
                                            <input type="submit" class="btn btn-primary" name="add2" value="Add to cart">
                                            <input type="submit" class="btn btn-primary"  name="buy2" value="Buy Now">  </div>
                            ...
                            <div class="card w-20" style="width:18rem;margin-right:50px; margin-bottom: 20px">
                                <img class="card-img-top" src="Kurti3.webp" alt="" >
                                <div class="card-body">
                                    <h5 class="card-title">Card title</h5>
                                    <h6 class="price">Price: Rupees 1200/-</h6>
                                    <h6 class="category">Category: some category</h6>
                                     <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="" name="p3" id="defaultCheck1">
                                        <label class="form-check-label" for="defaultCheck1">
                                            Small
                                        </label>
                                    </div>
                                    ...
                                    <div class="mt-4 d-flex justify-content-between">
                                        <input type="submit" class="btn btn-primary" name="add3" value="Add to cart">
                                        <input type="submit" class="btn btn-primary"  name="buy3" value="Buy Now">
                                    </div>


                                </div>
                            </div>
                            <div class="card w-20" style="width:18rem; margin-bottom: 20px">
                                <img class="card-img-top" src="kurti4.webp" alt="" >
                                <div class="card-body">
                                    <h5 class="card-title">Card title</h5>
                                    <h6 class="price">Price: Rupees 2500/-</h6>
                                    <h6 class="category">Category: some category</h6>
                                     <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="" name="p4" id="defaultCheck1">
                                        <label class="form-check-label" for="defaultCheck1">
                                            Small
                                        </label>
                                    </div>
                                    ...
                                    <div class="mt-4 d-flex justify-content-between">
                                        <input type="submit" class="btn btn-primary" name="add4" value="Add to cart">
                                        <input type="submit" class="btn btn-primary"  name="buy4" value="Buy Now">
                                    </div>
                            ...
                            <div class="card-deck">
                                <div class ="row">
                                    <div class="card w-20" style="width:18rem;margin-right:50px; margin-bottom: 20px">
                                        <img class="card-img-top" src="kurti5.webp" alt="" >
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h6 class="category">Category: some category</h6>
                                            <div class="mt-4 d-flex justify-content-between">
                                                <input type="submit" class="btn btn-primary" name="add5" value="Add to cart">
                                                <input type="submit" class="btn btn-primary"  name="buy5" value="Buy Now">
                                            </div>

                                        </div>
                                    </div>
                                    <div class="card w-20" style="width:18rem;margin-right:50px; margin-bottom: 20px">
                                        <img class="card-img-top" src="kurti1.webp" alt="" >
                                        <div class="card-body">
                                            <h5 class="card-title">Card title</h5>
                                            <h6 class="price">Price: Rupees 1000/-</h6>
                                            <h6 class="category">Category: some category</h6>
                                            <div class="mt-4 d-flex justify-content-between">
                                                <input type="submit" class="btn btn-primary" name="add6" value="Add to cart">
                                                <input type="submit" class="btn btn-primary"  name="buy6" value="Buy Now">
                                            </div>
                                    ...
                                    <div class="card w-20" style="width:18rem;margin-right:30px; margin-bottom: 20px">
                                        <img class="card-img-top" src="kurti1.webp" alt="" >
                                        <div class="card-body">
                                            <h5 class="card-title">Card title</h5>
                                            <h6 class="price">Price: Rupees 1200/-</h6>
                                            <h6 class="category">Category: some category</h6>
                                            <div class="mt-4 d-flex justify-content-between">
                                                <input type="submit" class="btn btn-primary" name="add7" value="Add to cart">
                                                <input type="submit" class="btn btn-primary"  name="buy7" value="Buy Now">
                                            </div>
                                    ...
                                    <div class="card w-20" style="width:18rem;">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h6 class="category">Category: some category</h6>
                                            <div class="mt-4 d-flex justify-content-between">
                                                <input type="submit" class="btn btn-primary" name="add8" value="Add to cart">
                                                <input type="submit" class="btn btn-primary"  name="buy8" value="Buy Now">
                                            </div>
